...
impl BoardHash {
    ...
    ///
    /// ```
    /// # use semantic_decision_contracts::BoardHash;
...
impl EvidenceRecordHash {
    ...
    ///
    /// ```
    /// # use semantic_decision_contracts::EvidenceRecordHash;
...
impl FiniteScore {
    ...
    ///
    /// ```
    /// # use semantic_decision_contracts::FiniteScore;
...
impl DispositionPolicy {
    ...
    ///
    /// ```
    /// # use semantic_decision_contracts::DispositionPolicy;
...
mod tests {
    ...
    #[test]
    fn v1_bpmn_shaped_json_and_hashes_are_golden() {
        let board = rich_board();
        let evidence = complete_evidence(&board);

        assert_eq!(
            board.board_hash.as_str(),
            "ce7c20d907063b3c0219a7255f58865ff96c44e873e8b3ba03a2c4d47cf79de3"
        );
        assert_eq!(
            evidence.evidence_record_hash.as_str(),
            "bbff36362654e2367d1ead8533532f112f97374cad78a78db0c6dc964be253a8"
        );
        assert_eq!(
            serde_json::to_string(&board).unwrap(),
            r#"{"schema_version":1,"domain":"bpmn-authoring","semantic_snapshot":"pack-v1","graph_revision":"rev-1","position":{"anchor":"task-1","context_hash":"context-1"},"candidates":[{"canonical_id":"op.append_node","schema_version":1,"title":"Append task","intent_summary":"Append one task","action_class":"create","applicability":"At a sequence end","effect":"Adds one task","arguments":[{"name":"task_name","kind":"identifier","required":true,"clarification_prompt":"What should the task be called?"}],"phrases":[{"text":"add a task","locale":"en","role":"canonical","provenance":"authored"}],"positive_examples":["Add a task at the end"],"negative_contrasts":[{"candidate_id":"op.insert_after","distinction":"append always targets the sequence end"}],"risk":"reversible","adapter_payload_hash":"adapter-v1"},{"canonical_id":"abstain.none_of_the_above","schema_version":1,"title":"None of the above","intent_summary":"No available legal action matches the request","action_class":"review","applicability":"Always available as explicit abstention","effect":"No operation and no mutation","arguments":[],"phrases":[],"positive_examples":["That is not what I meant"],"negative_contrasts":[],"risk":"read_only","adapter_payload_hash":"5b9a28862dbd6a80a1f11db739957670153466b5b0c5e86c28e88c3cbdfdbed5"}],"policy_fingerprint":"policy-v1","board_hash":"ce7c20d907063b3c0219a7255f58865ff96c44e873e8b3ba03a2c4d47cf79de3"}"#
        );
        assert_eq!(
            serde_json::to_string(&evidence).unwrap(),
            r#"{"board_hash":"ce7c20d907063b3c0219a7255f58865ff96c44e873e8b3ba03a2c4d47cf79de3","turn_context_hash":"turn","candidate_serializer_hash":"serializer","producer_bundle_hash":"producer","ranked":[{"candidate_id":"op.append_node","lane_scores":[{"lane":"lexical","score":0.9}],"final_score":0.9},{"candidate_id":"abstain.none_of_the_above","lane_scores":[{"lane":"lexical","score":0.1}],"final_score":0.1}],"evidence_record_hash":"bbff36362654e2367d1ead8533532f112f97374cad78a78db0c6dc964be253a8"}"#
        );
    }
}
